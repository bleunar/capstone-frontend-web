        ...
        >
          <div className="d-flex justify-content-between w-100 align-items-center">
            ...
            <div>
              <button
                type="button"
                className={`btn btn-sm me-2 ${!bulkMode ? "btn-light" : "btn-outline-light"
                  }`}
              ...
              <button
                type="button"
                className={`btn btn-sm ${bulkMode ? "btn-light" : "btn-outline-light"
                  }`}
...
export default function ManageLaboratoryDefault() {
