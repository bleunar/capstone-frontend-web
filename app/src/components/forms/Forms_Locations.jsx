            ...
            <div className="container my-4">
                <div className="mb-4">
                    <div className="row row-cols-2 p-2">
                        ...
                        <div className="col text-capitalize">{data?.name}</div>
                    </div>
...
export const ItemVisualizerContent_Locations = ({ data, mode = "list" }) => {
    ...
    if (mode == 'list') {
        return (
            <>
                <td>{data.name}</td>
                <td className='text-muted text-capitalize'>{data.description}</td>
            </>
        )
    }
        ...
        return (
            <div className="">
                ...
                <div className="p-2 mt-2 rounded bg-body-tertiary">
                    <div className="p text-capitalize">{data.description ? data.description : <span class="spinner-border spinner-border-sm" aria-hidden="true"></span>}</div>
                </div>
            </div>
        )
    }
