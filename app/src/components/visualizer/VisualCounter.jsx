...
export default function VisualCounter({ title, count, unit_type='', type = "primary" }) {
    return (
        <div className="col p-1">
            <div className={`p-1 d-flex justify-content-center text-light text-start flex-column h-100 bg-body-tertiary rounded border text-body ${type}`}>
                <div className="d-flex align-items-baseline justify-content-center">
                    <div className="h2 mb-0 fw-bold">{count}</div>
