...
function AdminLayout() {
  ...
  const sidebarLinks = [
    ...
    { icon: <FaNetworkWired />, label: "Labs & Computers", path: "/dashboard/laboratory" },
    { icon: <FaClipboardList />, label: "Reports", path: "/dashboard/report" },
    { icon: <FaUsers />, label: "Users & Roles", path: "/dashboard/user" },
  ];
